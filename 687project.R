...
#completeData<-data.frame(completeData$GP_Tier_H,completeData$Guest.NPS.Goal_PL,completeData$City_PL,completeData$Country_PL,completeData$NPS_Type,
 #                        completeData$Likelihood_Recommend_H,completeData$Guest_Room_H,completeData$Tranquility_H,completeData$Condition_Hotel_H,
  #                       completeData$Customer_SVC_H,completeData$Staff_Cared_H,completeData$Internet_Sat_H,completeData$Check_In_H,completeData$Bell.Staff_PL,
   #                      completeData$Convention_PL,completeData$Dry.Cleaning_PL,completeData$Fitness.Center_PL,completeData$Business.Center_PL,
    #                     completeData$Golf_PL,completeData$Laundry_PL,completeData$Limo.Service_PL,completeData$Restaurant_PL,completeData$Shuttle.Service_PL,
     #                    completeData$Spa_PL,completeData$Valet.Parking_PL,completeData$Hotel.Name.Long_PL,completeData$Property.Latitude_PL,completeData$Property.Longitude_PL,
      #                   completeData$Class_PL,completeData$Relationship_PL,completeData$Booking_Channel,completeData$Internet_Dissat_Lobby_H,completeData$Internet_Dissat_Slow_H,
       #                  completeData$Internet_Dissat_Expensive_H,completeData$Internet_Dissat_Connectivity_H,completeData$Internet_Dissat_Billing_H,completeData$Internet_Dissat_Billing_H,
        #                 completeData$Internet_Dissat_Wired_H,completeData$Room_Dissat_Internet_H,completeData$Status_H,completeData$Room_Type_H,
         #                completeData$Language_H,completeData$Age_Range_H,completeData$Gender_H,completeData$Guest_Country_H)
View(completeData)
str(completeData)
...
jl <- sum(is.na(HyattRegency_validation$Guest_Room_H))
jl
HyattRegency_validation <- na.omit(HyattRegency_validation)
jkk <- sum(is.na(HyattRegency_validation$Guest_Room_H))
jkk
...
model.svm = svm(Likelihood_Recommend_H ~ Condition_Hotel_H+
                   Guest_Room_H+
                   Customer_SVC_H+
                   Staff_Cared_H ,data = mydata.train)
...
predicted_svm
table(predicted_svm)
actual = mydata.test$Likelihood_Recommend_H
var = actual - predicted_svm

scatterchartgraph1 = ggplot(data = mydata.test,aes(x=mydata.test$Likelihood_Recommend_H, y=mydata.test$Condition_Hotel_H+Customer_SVC_H+Guest_Room_H+Staff_Cared_H)) + geom_point(aes(size= var,	color= var))
scatterchartgraph1


######################
#KSVM
modelksvm <-ksvm(Likelihood_Recommend_H ~
                    Condition_Hotel_H+
                    Guest_Room_H+
                    Customer_SVC_H+
                    Staff_Cared_H,
...
unique(completeData$Likelihood_Recommend_H)

predictedksvm <-predict(model.ksvm,mydata.test, type="r")
predictedksvm
mydata.test
nrow(mydata.test)
...
table(predictedksvm)
results <- table(predictedksvm, mydata.test$Likelihood_Recommend_H)
...
table(predictedksvm, mydata.test$Condition_Hotel_H)
table(predictedksvm, mydata.test$Guest_Room_H)
table(predictedksvm, mydata.test$Staff_Cared_H)
table(predictedksvm, mydata.test$Customer_SVC_H)


# check the predicted value 
predictedksvm
scatterchartgraphksvm = ggplot(data = mydata.test,aes(x=mydata.test$Guest_Room_H, y=mydata.test$Condition_Hotel_H)) + geom_point(aes(size= predictedksvm,	color= mydata.test$Likelihood_Recommend_H))
